...
export function initBrandManager() {
      ...
      <div class="modal-card" style="max-width: 580px;">
        <div class="modal-header">
          <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h3 style="font-size: 20px;">Brand profile</h3>
          </div>
          <button id="btn-close-brand-modal" class="btn btn-ghost btn-icon" type="button" aria-label="Close brand profile">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <form id="brand-form" style="display: flex; flex-direction: column; gap: 14px; margin-top: 10px;">
          <div class="brand-field-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
            <div class="setting-item">
              <label class="setting-label">Brand or channel name</label>
  ...
  function renderAuditorModal() {
      ...
      <div class="modal-card">
        <div class="modal-header">
          <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h3 style="font-size: 20px;">Channel audit</h3>
          </div>
          <button id="btn-close-auditor-modal" class="btn btn-ghost btn-icon" type="button" aria-label="Close channel audit">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <line x1="18" y1="6" x2="6" y2="18"></line>
              <line x1="6" y1="6" x2="18" y2="18"></line>
            </svg>
        ...
        <p style="color: var(--text-secondary); font-size: 13px; margin-bottom: 20px; line-height: 1.5;">
          Add a YouTube channel URL or handle. Shoort Clips will review available channel signals and create a starting brand direction.
        </p>
        ...
        <form id="auditor-form" style="display: flex; flex-direction: column; gap: 14px;">
          <div class="setting-item">
            ...
            <input type="text" id="audit-channel-url" placeholder="https://www.youtube.com/@yourchannel" required>
          </div>
          <div class="setting-item">
            <label class="setting-label">What should the audit prioritize? <span>(optional)</span></label>
            <input type="text" id="audit-context" placeholder="Example: customer stories, tutorials, or product education">
          </div>
        ...
        <div id="audit-results-card" class="audit-results-card" style="display: none; margin-top: 24px; border-radius: var(--radius-md); padding: 18px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
            <div class="badge badge-emerald">Audit Synthesized</div>
            <button id="btn-apply-audit" class="btn btn-primary btn-sm">Use for brand profile</button>
          </div>
    ...
    auditorForm.addEventListener('submit', async (e) => {
      ...
      btn.disabled = true;
      btn.innerHTML = '<span class="anim-spin"></span> Reviewing channel…';
