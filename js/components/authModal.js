...
import { signInWithGoogle, signInWithEmail, getCurrentUser } from '../supabase.js';
...
export function initAuthModal() {
  ...
  function render() {
      ...
      <div class="modal-card">
        <div class="modal-header">
          <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <h3 style="font-size: 20px;">Sign In to Your Studio</h3>
          </div>
          <button id="btn-close-auth-modal" class="btn btn-ghost btn-icon">
        ...
        <div style="display: flex; gap: 8px; margin-bottom: 16px; border-bottom: 1px solid var(--border-glass); padding-bottom: 10px;">
          <button id="tab-sign-in" class="btn btn-sm btn-primary" style="flex: 1;">Sign In</button>
          <button id="tab-sign-up" class="btn btn-sm btn-ghost" style="flex: 1;">Create Account</button>
        </div>
        ...
        <form id="email-auth-form" style="display: flex; flex-direction: column; gap: 14px;">
          ...
          <button type="submit" id="btn-submit-email-auth" class="btn btn-primary" style="margin-top: 6px;">Sign In to Studio</button>
        </form>
      </div>
    `;
    ...
    tabSignIn.addEventListener('click', () => {
      ...
      submitBtn.textContent = 'Sign In to Studio';
    });
    ...
    tabSignUp.addEventListener('click', () => {
      ...
      submitBtn.textContent = 'Create Studio Account';
    });
    ...
    modalEl.querySelector('#email-auth-form').addEventListener('submit', async (e) => {
      ...
      submitBtn.innerHTML = '<span class="anim-spin">⚡</span> Processing...';
